		...
		$.each(result, function(index, cf) {
			if (cf.Name == 'Delete Cart' && cf.Code.startsWith(customFieldPrefix)) {
				...
				if (pluginStatus == 'true') {
					if(userId) {
						$(".header .main-nav ul .cart-menu .cart-item-counter").append('<span class="cart-delete-item"></li>');
						var imgLink =   "http://" + hostname + "/user/plugins/" + packageId + "/images/delete.svg"; 
